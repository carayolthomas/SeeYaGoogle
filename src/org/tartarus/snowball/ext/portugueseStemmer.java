...
public class portugueseStemmer extends org.tartarus.snowball.SnowballStemmer {
	...
	private final static Among a_7[] = { new Among("a", -1, 1, "", methodObject), new Among("i", -1, 1, "", methodObject), new Among("o", -1, 1, "", methodObject), new Among("os", -1, 1, "", methodObject), new Among("\u00E1", -1, 1, "", methodObject), new Among("\u00ED", -1, 1, "", methodObject), new Among("\u00F3", -1, 1, "", methodObject) };

	private final static Among a_8[] = { new Among("e", -1, 1, "", methodObject), new Among("\u00E7", -1, 2, "", methodObject), new Among("\u00E9", -1, 1, "", methodObject), new Among("\u00EA", -1, 1, "", methodObject) };
